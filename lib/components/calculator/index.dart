    ...
    setState(() {
      if (_showingExpression) {
        ...
        if (_currentInput.isNotEmpty && _currentInput != '0') {
          _currentInput = _currentInput.substring(0, _currentInput.length - 1);
          if (_currentInput.isEmpty || _currentInput == '' || _currentInput == '-') {
            _currentInput = '0';
          }
          _updateDisplayWithExpression();
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: TextField(
                      decoration: InputDecoration(
                        ...
                        hintStyle: TextStyle(color: Color(0xFFCCCCCC), fontSize: 14.r),
                  ...
                  Text(
                    "￥ $_displayValue",
                    style: TextStyle(color: Color(0xFFFF2B2F), fontSize: 20.r, fontWeight: FontWeight.bold),
                  ),
                ],
              ),
            ),
